...
<head>
    ...
    <title>Tambah Kategori | APSS Admin</title>
    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <nav class="flex text-[10px] font-bold uppercase tracking-widest text-outline mb-1">
                ...
                <span class="text-primary">Tambah Baru</span>
            </nav>
            <h1 class="text-3xl font-extrabold text-on-surface tracking-tight font-headline">Tambah Kategori</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.kategori.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input required autofocus 
                    ...
                    placeholder="Contoh: Sarana Olahraga" type="text" value="{{ old('nama_kategori') }}"/>
                @error('nama_kategori')
