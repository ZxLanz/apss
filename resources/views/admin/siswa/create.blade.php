...
<main class="max-w-screen-2xl mx-auto px-8 py-8">
    <div class="mb-10">
        <nav class="flex text-sm font-medium text-on-surface-variant mb-2">
            ...
            <span class="text-primary">Tambah Siswa Baru</span>
        </nav>
        <h1 class="text-4xl font-extrabold text-on-surface tracking-tight mb-2">Tambah Siswa Baru</h1>
        <p class="text-on-surface-variant max-w-2xl">Masukkan data siswa baru yang akan terdaftar di aplikasi APSS.</p>
    </div>
            ...
            <form action="{{ route('admin.siswa.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select name="kelas" class="w-full px-4 py-3 bg-surface-container-low border border-surface-variant rounded-lg focus:ring-2 focus:ring-primary/40 focus:border-transparent text-on-surface cursor-pointer" required>
                        ...
                        <option value="XIII" {{ old('kelas') == 'XIII' ? 'selected' : '' }}>Kelas XIII</option>
                    </select>
                    @error('kelas')
                        <p class="text-error text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('password')" class="absolute right-3 top-1/2 -translate-y-1/2 text-outline hover:text-primary transition-colors">
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('password_confirmation')" class="absolute right-3 top-1/2 -translate-y-1/2 text-outline hover:text-primary transition-colors">
