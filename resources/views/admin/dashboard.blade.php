...
<nav class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl flex justify-between items-center px-8 py-4 w-full max-w-full mx-auto docked full-width top-0 sticky z-50">
    <div class="flex items-center gap-8">
        ...
        <div class="hidden md:flex items-center gap-6">
            <a class="text-blue-700 dark:text-blue-400 font-bold border-b-2 border-blue-600 px-1 py-1 text-sm tracking-tight transition-all duration-200" href="{{ route('admin.dashboard') }}">Dashboard</a>
            <a class="text-slate-500 hover:text-blue-600 px-1 py-1 text-sm tracking-tight transition-colors" href="{{ route('admin.siswa.index') }}">Siswa</a>
            <a class="text-slate-500 hover:text-blue-600 px-1 py-1 text-sm tracking-tight transition-colors" href="{{ route('admin.kategori.index') }}">Kategori</a>
            <a class="text-slate-500 hover:text-blue-600 px-1 py-1 text-sm tracking-tight transition-colors" href="{{ route('admin.laporan.index') }}">Laporan & Aspirasi</a>
        </div>
    </div>
